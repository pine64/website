...
Powering the link:/documentation/ROCKPro64/_index[ROCKPro64] single-board computer from an ATX power supply allows the board to be powered with more than just two disks, and is a reliable and safe way to power it from your household mains.
...
* *A soldering iron*, e.g. the link:/documentation/Pinecil/_index[Pinecil], with some solder
