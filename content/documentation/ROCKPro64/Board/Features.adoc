...
| https://pine64.com/product/rockpro64-1x1-dual-band-wifi-802-11ac-bluetooth-5-0-module/[ROCKPro64 1x1 Dual Band WiFi 802.11AC / Bluetooth 5.0 Module]
...
|
|
| Configure ip on usb0: ifconfig usb0 169.169.222.222 and run iperf, you should likely see about 200-300MB/s
| link:/documentation/ROCKPro64/Getting_started/#otg_mode[ROCKPro64]
|
