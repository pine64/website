...
For details regarding the boot priority on the PinePhone Pro see link:/documentation/PinePhone_Pro/_index#Boot_order[PinePhone Pro].
...
. On the *PinePhone Pro*: The eMMC might have to be disconnected to boot from the microSD card, see link:/documentation/PinePhone_Pro/_index#Boot_order[PinePhone Pro]
. Boot phone
