...
image:/documentation/images/Martjin_VCONN_switches_1.1.jpg[thumb|frame|Close-up picture of the two identical switches the issue originates from, with the ANX USB controller in the frame,title="thumb|frame|Close-up picture of the two identical switches the issue originates from, with the ANX USB controller in the frame"]

image:/documentation/images/Schematic_VCONN_switches.png[thumb|frame|Excerpt from the PinePhone schematic showing the two components.,title="thumb|frame|Excerpt from the PinePhone schematic showing the two components."]
