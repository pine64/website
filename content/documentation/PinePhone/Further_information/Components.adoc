...
* Note: The link:/documentation/PinePhone/Further_information/Components/[PinePhone page] lists the SGM3140, but the schematics contain the U1000: awinic AW3641EDNR, so it is unclear why the SGM3140 is needed.
