...
Follow the steps for link:#creating_a_mainline_boot_image[Creating a mainline boot image], but instead of flashing it with ''rkdeveloptool'', use ''fastboot''. You can enter fastboot in either of two ways:
