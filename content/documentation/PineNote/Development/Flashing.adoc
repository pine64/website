...
It should output something like "_DevNo=1 Vid=0x2207,Pid=0x350a,LocationID=202 Maskrom_". If it doesn't, see link:/documentation/PineNote/Development#Entering_Maskrom_Mode[PineNote Development].
