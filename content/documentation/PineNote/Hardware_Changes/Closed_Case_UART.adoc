...
image:/documentation/images/PineNote_USB-C_DAM_Schematic_Addition.png[thumb|This proposed circuitry is added to the PineNote v1.1 schematic,title="thumb|This proposed circuitry is added to the PineNote v1.1 schematic"]
