...
Once the template is copied, you can start editing the blog post details. Below is an example of a blog posts basic layout with some explanations of each option does (with explanation after "//"):

```md {linenos=inline}
title: "PROJECT update: TAGLINE"    // The title for the blog post.
date: "yyyy-mm-dd"                  // Date of publishing.
authors: ["Name of author"]         // Author(s) of the blog post. 
categories:
  - "community"
  - "news"
  - "pine64-community"
tags:
  - "tag_1"                         // E. g. "pinetab2", "pinenote"
  - "tag_2"
images:                             // Cover art (preview and embedded)
  - "/blog/images/pine64_banners/pine64_blue.png" 
summary: "Summary about the contents"
    // Blog post summary, used in RSS and blog post list

---

![Blog post banner artwork](/blog/images/pine64_banners/pine64_blue.png)
    // Cover art found in the blog post itself.

{{</* toc */>}}
    // Creates the table of contents

## HEADING TITLE
    // First headline, put what your blog post is about here.
```
