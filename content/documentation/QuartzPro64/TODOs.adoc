...
Current neggles kernel has the CPU at 1.2 GHz, apparently SRE has patches to enable cpufreq? (see below, in link:/documentation/QuartzPro64/_index#Kernel[Resources])
