...
It is possible to install Debian onto eMMC of the link:/documentation/Quartz64/_index[Quartz64] from the pgewipout quartz64_ci imaged to a Micro SDcard, or vice versa.
