...
The link:/documentation/Quartz64/_index[Quartz64] single-board computers (both Model A and Model B) come with MIPI-DSI ports for connecting a MIPI-DSI compatible display.
