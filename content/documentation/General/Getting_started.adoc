...
This guide is for the PINE64 devices. For device-specific information please see the corresponding device pages listed on the link:/documentation/_index#Devices|main page[main page].
...
* link:#Imaging microSD on Windows 7/8/8.1/10|Imaging microSD on Windows 7/8/8.1/10[Imaging microSD on Windows 7/8/8.1/10]
* link:#Imaging microSD on Apple OSX|Imaging microSD on Apple OSX[Imaging microSD on Apple OSX]
* link:#Imaging microSD on Linux|Imaging microSD on Linux[Imaging microSD on Linux]
...
You can find OS images for the respective devices in the link:/documentation/_index#Devices|device section[device section] of the main page.
...
*This process of flashing an OS image to eMMC is *completely identical to imaging micro SD cards*, so please read link:/documentation/General/Getting_started#Step-by-Step_Instructions_to_Flashing_MicroSD_Cards|Step-by-Step Instructions to Flashing Micro SD Cards[Step-by-Step Instructions to Flashing Micro SD Cards] before you begin.
