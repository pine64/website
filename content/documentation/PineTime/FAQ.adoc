...
Also see link:/documentation/PineTime/Software/Reprogramming/[this page to see various methods of reprogramming the devkit PineTime the wired way].
...
There are several ways you can do this, check out link:/documentation/PineTime/Software/Reprogramming/[Reprogramming the PineTime]
