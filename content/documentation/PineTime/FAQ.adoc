...
Chat with the PineTime Community on link:/documentation/PineTime/_index#Community|Matrix / Discord / Telegram / IRC[Matrix / Discord / Telegram / IRC] (They are bridged into a single chatroom)
