...
If you get stuck or have any questions, join us on your preferred link:/documentation/_index#Chat_Platforms|chat platform[chat platform] or the product https://forum.pine64.org/forumdisplay.php?fid=134[forum]. There's usually someone available who can help, or will get back to you in a few hours.
