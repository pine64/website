...
. Pine Store can not sell on AliExpress (see above). All AliExpress items using the PINE64 and Pinecone logos are fake copies (link:/documentation/Pinecil#authenticity[see authenticity here]).
