...
3. Adding a small amount of solder to your tip before starting increases the thermal mass of the tip and could help instead of cranking the temperature super high (which causes other problems). See the link:#General_soldering_guides|soldering guides[soldering guides] above for demonstrations of this in several articles and videos.
