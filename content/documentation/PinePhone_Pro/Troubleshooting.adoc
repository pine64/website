...
* Prepare a microSD card as explained in the section link:/documentation/PinePhone_Pro/_index#Flashing to microSD card|Flashing to microSD card[Flashing to microSD card]
...
* Power on the device while bypassing the SPI and eMMC as explained under link:/documentation/PinePhone_Pro/_index#Boot order|Boot order[Boot order]
