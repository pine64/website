...
$ sudo ./ppp/spinor-flash-initial-setup.sh
----
...
WARNING: Repeat the link:#building[building process] for each needed distribution, adapting link:#variables[needed variables].
