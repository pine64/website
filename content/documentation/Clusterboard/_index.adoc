...
image:/documentation/Clusterboard/images/Clusterboard_rev_2.2.jpg[Front view of the Clusterboard (revision 2.2),title="Front view of the Clusterboard (revision 2.2)",width=400]
