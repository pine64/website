...
You need to buy and install the M.2 adapter in order to fit one, please see link:/documentation/Pinebook_Pro/_index#Using_the_optional_NVMe_adapter[Pinebook Pro]
