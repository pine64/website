...
Please see link:/documentation/Pinebook_Pro/Troubleshooting#NVMe SSD issues[a separate section] that describes reported issues with the NVMe drives in PineBook Pro.
...
* PS 0: 3.5W +
* PS 1: 2.4W +
* PS 2: 1.9W | No. Fixed by systemd script, see https://wiki.pine64.org/wiki/Pinebook_Pro#Post_NVMe_install_power_limiting[Wiki].
