...
image:/documentation/images/Wr_Termite2.JPG[thumb|Termite_Setup_Screen,title="thumb|Termite_Setup_Screen"]_image:/documentation/images/Wr_cfghelp_scr.JPG[thumb|Help Command,title="thumb|Help Command"]
