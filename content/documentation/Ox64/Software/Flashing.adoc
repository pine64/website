...
Note that the addresses are different according to the flashing method, DevCube or CLI. Bf-mcu-tool will add a 0x2000 offset to address specified by CLI arg.
