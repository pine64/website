...
If necessary wipe beginning of the microSD card.
...
Mount the image, copy boot and rootfs to the partitions. You need also to make some changes on some files.
...
Edit `/extlinux/extlinux.conf` to add a new Nuttx boot option.
