...
(however see the section link:#compatible_uarts[Compatible UARTs] and link:#using_a_serial_adapter_other_than_the_pico[Using a serial adapter other than the Pico]).
